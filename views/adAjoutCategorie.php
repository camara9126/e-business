        ...
        <div class="mt-4">
            ...
            <form action="" method="post">
                <div class="form-group row">
                    ...
                    <input type="text" name="nom" value="<?=isset($categories)? $categorie->nom:'' ?>"
                         class="form-control col-md-9 text-left" placeholder="" aria-describedby="helpId">
                </div>
                ...
                <div class="row">
                    ...
                    <a type="submit" href="?admin=categorie" class="btn btn-light">Retour</a>
